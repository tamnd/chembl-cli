...
Most of these come down to network reality or how chembl serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

chembl rate-limits like any public site. chembl already paces
...
Where a surface is gated, chembl reads a cookie or token you supply
...
`chembl`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what chembl actually did
